  ...
  methods:{
    ...
    async getUserCenterFollowingGroups(){
      ...
      if(response.data){
        ...
        this.totalFollowingCount = this.followingGroups
            .map(item => item['count'])
            .reduce((x, y) => x + y, 0); // Add ", 0" here
...
<!--      我的关注-->
      <div class="title">
        ...
        <el-dialog
          ...
          <input type="text"
                 v-model="groupName"
                 placeholder="At most 16 characters" maxlength="16"
                  style="width: 100%">
          <span slot="footer" class="dialog-footer">
            <el-button @click="showAddGroupDialog = false">Cancel</el-button>
            <el-button type="primary" @click="addUserFollowingGroups">Confirm</el-button>
          </span>
        </el-dialog>
      </div>
<!--      导航菜单-->
            ...
            <div class="operation">
              <el-dropdown>
                <el-button type="primary">
                  Subscribed<i class="el-icon-arrow-down el-icon--right"></i>
                </el-button>
                <el-dropdown-menu>
                  <el-dropdown-item>
              ...
              <el-dialog
                  title="You are moving 1 following user"
...
<!--            相关粉丝操作-->
            <div class="userFollowing-operation">
              <el-dropdown v-if="visible(userFan.userId)">
                <el-button type="primary">
                  Mutual Follow<i class="el-icon-arrow-down el-icon--right"></i>
                </el-button>
                <el-dropdown-menu>
                  <el-dropdown-item>
                    <el-button type="text" style="color: black"
              ...
              <el-dialog
                  title="You are moving 1 followed user"
                  :visible.sync="showMoveFollowingGroupDialog"
                  width="30%">
                <MoveFollowingGroupDialog :followingGroups="followingGroups"
                                      :followingId="currentFollowingId"
