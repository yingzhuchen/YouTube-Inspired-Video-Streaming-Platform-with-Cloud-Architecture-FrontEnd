...
<div class="my-space-collection">
  ...
  <div class="my-space-collection-container">
      ...
      <div class="title">
        ...
        <el-dialog
          ...
          <span slot="footer" class="dialog-footer">
            <el-button @click="showAddCollectionDialog = false">Cancel</el-button>
            <el-button type="primary" @click="addUserCollectionGroups">Confirm</el-button>
          </span>
        </el-dialog>
      </div>
    ...
    <div class="my-space-collection-content">
          ...
          <div class="collection-videos-item-detail">
            ...
            <div class="collection-video-info">
              ...
              <div class="collection-video-info-createTime">
                <span>
                  Collected to：{{collection.videoInfo.createTime}}
                </span>
      ...
      <el-dialog
          title="You are moving a video to"
