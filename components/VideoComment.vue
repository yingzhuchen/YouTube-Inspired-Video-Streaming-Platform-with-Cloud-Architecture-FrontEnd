        ...
        <div class="comment-send-area-before-login">
          ...
          <div class="comment-input-before-login">
            <textarea class="comment-input-textarea"
                      placeholder="Login to view and comment" v-model="comment">
            </textarea>
          </div>
          <div class="comment-button-before-login">
            ...
            <el-dialog title="Login" :visible.sync="showLoginDialog" width="30%">
              <LoginDialog/>
            </el-dialog>
          </div>
        </div>
...
<!--        输入评论区 and 发送-->
        <div class="comment-send-area">
          ...
          <div class="comment-input">
            <textarea class="comment-input-textarea" placeholder="The sky is blue waiting for the rain, and the comment section is waiting for you."
                      v-model="comment">
            </textarea>
          </div>
              ...
              <div class="sub-reply-content-container"
                ...
                <div class="sub-reply-content">
                  ...
                  <div class="sub-reply-wrap">
                    <div >
                      Reply{{childComment.replyUserInfo.nick}}：
                    </div>
...
<!--              回复某一个用户的评论区域-->
              <div class="reply-comment-area"
                ...
                <div class="reply-comment-input">
                  <textarea class="comment-input-textarea"
                              :placeholder="'Reply' + commentUserName"
                              v-model="replyTxt">
                  </textarea>
                </div>
